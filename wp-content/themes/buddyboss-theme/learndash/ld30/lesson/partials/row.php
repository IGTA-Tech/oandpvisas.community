	...
	<div class="ld-item-list-item-preview">
		...
		<div class="ld-item-details">
			...
			if ( ! empty( $topics ) || ! empty( $quizzes ) ) :
				...
				<div aria-controls="<?php echo esc_attr( 'ld-expand-' . $lesson['post']->ID . '-container' ); ?>" class="ld-expand-button ld-button-alternate" data-ld-expands="<?php echo esc_attr( 'ld-expand-' . $lesson['post']->ID ); ?>" data-ld-expand-text="<?php esc_html_e( 'Expand', 'buddyboss-theme' ); ?>" data-ld-collapse-text="<?php esc_html_e( 'Collapse', 'buddyboss-theme' ); ?>">
